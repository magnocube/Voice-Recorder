...
/** @brief Dump all KSZ8081 PHY SMI configuration registers
 *
...
/** @brief Default KSZ8081 phy_check_init function.
 */
void phy_KSZ8081_check_phy_init(void);

/** @brief Default KSZ8081 phy_get_speed_mode function.
 */
eth_speed_mode_t phy_KSZ8081_get_speed_mode(void);

/** @brief Default KSZ8081 phy_get_duplex_mode function.
 */
eth_duplex_mode_t phy_KSZ8081_get_duplex_mode(void);

/** @brief Default KSZ8081 phy_power_enable function.
 *
 ...
 */
void phy_KSZ8081_power_enable(bool);

/** @brief Default KSZ8081 phy_init function.
 */
esp_err_t phy_KSZ8081_init(void);

/** @brief Default KSZ8081 PHY configuration
 *
 ...
 * Consult the Ethernet example to see how this is done.
 */
extern const eth_config_t phy_KSZ8081_default_ethernet_config;
