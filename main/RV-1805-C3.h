...
//NOTE: the end if this header will have a extern declaration of the instance of this class. the instance is made on the first line of the .cpp 

#include <stdint.h>
#include <stdio.h>
#include <driver/i2c.h> // for i2c writes,, should be done with a i2c manager in near future)
#include "esp_err.h"
